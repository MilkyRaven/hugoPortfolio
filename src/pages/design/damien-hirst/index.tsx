    ...
    return (
        <div>
            ...
            <div>
                ...
                <p className='ml-10 mr-10 mt-9 mb-9'>For this project I was to design the visual identity for artist Damian Hirst's upcoming exhibition. I researched Hirst's previous work and the target audience to create a cohesive design language that would work across mediums like logo, posters and banners.</p>
                <div className='flex flex-col items-center'>
